...
if place_meeting(x,y,RI_Water) or (place_meeting(x,y,RI_HardSpring1) or place_meeting(x,y,RI_MediumSpring1) or place_meeting(x,y,RI_EasySpring1) or place_meeting(x,y,RI_LangleSpring1) or place_meeting(x,y,RI_RangleSpring1))
{
Ride_Mode = 0
with Pers_Obj
{
...
if Pers_Obj.canHit = true && (Pers_Obj.sprite_index !=sprAmy_Capture2 && Pers_Obj.sprite_index !=sprAmy_Capture1) && Pers_Obj.BurstAble!=1
{
